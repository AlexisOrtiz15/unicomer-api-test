...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleHttpClientError(final HttpClientErrorException ex,
            final WebRequest request) {

        return handleExceptionInternal(ex, new HttpHeaders(), ex.getStatusCode(), request);
    }

    /**
     * Customize the response for RestResponseAppException.
     * 
     * @param ex the exception
     * @param request of the client
     * @return API error message
    ...
    public ResponseEntity<Object> handleResponseStatus(final ResponseStatusException ex,
            final WebRequest request) {

        return handleExceptionInternal(ex, new HttpHeaders(), ex.getStatus(), request);
    }
    ...
    public final ResponseEntity<Object> handleValidation(final ValidationException ex,
            final WebRequest request) {
    ...
    public ResponseEntity<Object> handleInvalidMimeType(final IllegalArgumentException ex,
            final WebRequest request) {
    ...
    public ResponseEntity<Object> handle500Exception(final Exception ex,
            final WebRequest request) {
    ...
    public ResponseEntity<Object> handleExceptionInternal(Exception ex, @Nullable Object body,
        ...
        if (Objects.isNull(body)) {
            final ApiErrorWrapper apiErrors = message(status, ex);
